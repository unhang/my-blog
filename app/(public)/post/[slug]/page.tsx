...
<meta property="og:description" content="A short, engaging description of your page." />
<meta property="og:image" content="yourdomain.com" />
<meta property="og:url" content="yourdomain.com" />
<meta property="og:type" content="website" /> <!-- Or "article", "video", etc. -->
...
export default async function Page({
  ...
  return (
    <div className="w-full min-h-[90vh] px-[32px] md:max-w-[768px] md:mx-auto">
      ...
      <p className="text-center">On Jan 12, 2027</p>
      ...
      <div>
        ...
        <p className='text-justify py-4'>
          Một bộ phận người Nhật không thích người nước ngoài, có thể nói là nặng là kỳ thị người ngoại quốc. Thời làm baito phát báo,  tôi vẫn nhớ vì phát nhầm tờ báo, một ông bác trong tiệm tức giận đến mức đấm tay xuống bàn và quát lớn “ベトナムにかえれ！” , tức là “Cút về Việt Nam!”. Còn một ông bác khác không bao giờ bắt chuyện với mấy đứa Việt Nam cùng tiệm. Ai cũng đi làm vì cuộc sống mà, sao khắc nghiệt thế.
        </p>
        <p className='text-justify py-4'>
